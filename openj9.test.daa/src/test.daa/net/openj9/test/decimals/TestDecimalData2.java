 ...
 *
 * @(#) tests/Intrinsics/com/ibm/test/TestDecimalData.java, tr.tests, tr.dev 1.2
 *
 */

/*
 * This is a hacked version of TestDecimalData, to improve performance when running under JLTF
 * The original version is very slow, not due to the methods under test, but due to the massive
 * use of Thread.getStackTrace() to calculate line numbers, and the huge amounts of String concatenation
 * done in the various methods which build the test name strings.
 * In a JLTF environment, this performance over-head causes over-runs, and causes more pain that it solves.
 */

package com.ibm.test.decimals;
